...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhấn vào nhịp tim anh nè " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Nhịp tim anh cao là vì:';
document.querySelector('.Description .modal-body').innerHTML = 'Anh yêu em nhiều lắm bé Mi <i class="fas fa-heart"></i> ';
